...
public class JwtUtil {
    ...
    // Called after login/register — generates a token with userId and email baked in
...
//---
//
//Your `security` folder should now look like this (you'll add the other two files next):
//```
//src/main/java/com/org/Triplens/
//└── security/
//    └── JwtUtil.java        ✅ done
//    └── JwtFilter.java      ← next
//    └── SecurityConfig.java ← after that